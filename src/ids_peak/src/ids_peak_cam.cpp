...
auto node = rclcpp::Node::make_shared("ids_peak_cam");
...
void ids_cam::camOpen()
{
  ...
  {
    auto logger = rclcpp::get_logger("nnv_log");
...
void ids_cam::camConfig()
{
  ...
  auto logger2 = rclcpp::get_logger("frra_log");
...
void ids_cam::camAcquisitionStop()
{
  ...
  auto logger = rclcpp::get_logger("Warn_Log");
